...
|---------------|-----------|
| City of Milwaukee SBE + LBE | 10% bid preference (cap $30K), 25% participation |
| WisDOT DBE → County TBE | 25% TBE goal |
...
Internal sales data (pricing, financials, templates) → [Chapter 8](ch8-sales-system.md)
