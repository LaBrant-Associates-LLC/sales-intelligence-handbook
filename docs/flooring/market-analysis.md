...
### Tier 1: Direct Competitors (Painting + Flooring Package)

#### IOC Construction (Inside Out Company)
**Threat Level: HIGH — Your closest business model competitor**

| Attribute | Details |
|-----------|---------|
| Headquarters | 1425 Paramount Pkwy, Suite B, Batavia, IL 60510 |
| Service Area | Greater Chicago and **Milwaukee Area** |
| Phone | 630-406-3000 |
| Key Contacts | David Lockhart, Tim Ross |
| Revenue | $25-50 million |
| Employees | 51-200 |
| Union Status | Non-union (merit shop) |

**Business Model:** Full-service GC for multifamily capital improvements offering painting, flooring, roofing, and construction services. They explicitly market to property managers for apartment/multifamily facilities, condo/townhome associations, and commercial high-rise.

**Services Include:**
- Painting (interior/exterior)
- Flooring (LVP, carpet, tile, epoxy)
- Roofing
- General construction/renovations
- Property maintenance

**Why They Matter:** IOC is essentially the Chicago version of what LaBrant is considering becoming. They've been serving the Chicagoland and Milwaukee market for 25 years with this integrated model. They target the exact same customer base—property managers and multifamily owners.

**Competitive Advantage Assessment:**
- (+) Established 25-year track record
- (+) Full GC capabilities (roofing, construction)
- (+) Strong technology adoption (JobTread, drone tech)
- (-) Chicago-based, Milwaukee is secondary market
- (-) No DBE/SBE certifications identified
- (-) Larger overhead structure

**LaBrant Opportunity:** Your Milwaukee-local presence, certification advantages (DBE, SBE), and existing GC relationships give you a local advantage IOC cannot match on diversity-focused projects.

---

#### Thomas A. Mason Painting Company
**Threat Level: MODERATE — Different market segment**

| Attribute | Details |
|-----------|---------|
| Headquarters | 1501 N. Dr. Martin Luther King Dr., Milwaukee, WI 53212 |
| Phone | 414-271-6688 |
| Founded | 1912 (112 years in business) |
| Employees | 80+ |
| Revenue | $12+ million estimated |
| Union Status | **UNION (IUPAT)** |
| Certifications | MBE, DBE |

**Business Model:** Wisconsin's largest painting contractor with integrated flooring division. Full-service painting and flooring for commercial, institutional, and industrial projects.

**Flooring Services:**
- Ceramic/quarry tile
- Resilient flooring (LVP, linoleum)
- Carpet and carpet tile
- Pre-finished engineered wood
- Vinyl wall covering

**Notable Projects:**
- Milwaukee City Hall ($60M restoration)
- Northwestern Mutual Towers/Commons
- General Mitchell International Airport
- The Trade Hotel (adjacent project)

**Why They're NOT Your Direct Competition:**
1. **Union-only** — Cannot bid merit-shop multifamily projects
2. **Institutional focus** — Government, airports, corporate HQ, not apartments
3. **Price point** — Union labor costs price them out of cost-sensitive multifamily
4. **Relationship base** — Works with union GCs (JP Cullen, Miron, Mortenson)

**LaBrant Opportunity:** Thomas A. Mason proves the painting + flooring model works in Wisconsin. Their union structure creates a massive gap in the merit-shop multifamily market that LaBrant can fill.
...
**Threat Level: LOW for multifamily — Union, institutional focus**

| Attribute | Details |
|-----------|---------|
| Location | N89 W14260 Patrita Drive, Menomonee Falls, WI 53051 |
| Phone | 262-437-9300 / 262-999-5727 |
| Founded | 1949 (75+ years) |
| Union Status | **UNION (INSTALL certified)** |
| Starnet Member | Yes (premier commercial flooring network) |

**Capabilities:** Full-service commercial flooring including tile, carpet, LVT, resilient, wood, rubber, sports flooring. NTCA Five-Star Contractor. Won awards for The Trade Hotel in Milwaukee (84,000 SF tile).

**Market Focus:** Healthcare, education, corporate, retail, hospitality, government. NOT primarily multifamily apartments.

**Contact:**
- Les Lippert, President
- Jeff Lippert, Executive Vice President

**Why Limited Threat:** Union status and institutional focus. They're bidding Franklin High School, Trade Hotel, and corporate interiors—not the Fiduciary/McShane/Greenfire multifamily projects LaBrant wins.
...
**Madison Commercial Contacts:**
- Billy Andersen: bandersen@floor360.com
...
**Threat Level: MODERATE — Local SE Wisconsin focus**

| Attribute | Details |
|-----------|---------|
| Location | 16601 W Glendale Dr, New Berlin, WI |
| Owner | Tyler Adair (37 years in trade) |
| Founded | Family business, Scott and Laura Werner |
| Phone | Contact via website |
| Union Status | Uses subcontractors (mixed) |

**Capabilities:** Carpet, carpet tile, LVT, resilient, ceramic tile, engineered wood. Serves projects from Kenosha to Superior, Wisconsin.

**Manufacturers Carried:** Interface Americas, Shaw Contract, Mannington Commercial, Cambridge Carpets, Nora Rubber, Gerflor Taraflex, Sovereign Stripwood, Armstrong, Johnsonite.

**Concerns:** One Yelp review mentions lien filed for non-payment to subs (2017CL000101, Waukesha County). Verify current financial standing before considering as subcontractor.

**Note:** Separate from Adair Floors N Mor (Franklin, WI) which is residential-focused and a Mohawk ColorCenter dealer.

---

#### United Flooring Inc.
**Threat Level: MODERATE — Established commercial focus**

| Attribute | Details |
|-----------|---------|
| Location | 5260 N. 126th Street, Butler, WI 53007 |
| Phone | 262-783-7171 / 414-586-4164 |
| Founded | 1987 by Bill Rickun |
| Ownership | Family-owned |
| Union Status | **UNION (INSTALL partner)** |
| Blue Book Listed | Since 2004 |

**Market Focus:** Office buildings, schools, hospitals, senior living facilities, retail, banks.

**Capabilities:** Broadloom carpet, tiles, vinyl tile, fitness floors, running tracks, hardwood floors, exotic woods.

**Why Limited Threat for Multifamily:** Union status and institutional focus (schools, hospitals). However, they do serve senior living—an area where LaBrant also has strong GC relationships (Stevens, Greenfire, McShane).

---

#### BYCO Tile and Floor
**Threat Level: LOW — Possible subcontractor partner**

| Attribute | Details |
|-----------|---------|
| Headquarters | P.O. Box 148, regional coverage |
| Phone | 262-894-6995 |
| Founded | 1953 (70+ years) |
| Certifications | **MBE, SBE, DBE WI** |
| Union Status | Non-union |

**Service Area:** Appleton, Beaver Dam, Columbus, Fond Du Lac, Madison, Menomonee Falls, Milwaukee, Monroe, Muskego, Oconomowoc, Oshkosh, Watertown, Waukesha, Waupun, West Bend.

**Why They're Interesting:** BYCO holds the same DBE/SBE certifications as LaBrant. They could be:
1. A subcontractor partner for flooring work
2. A competitor on diversity-focused projects
3. A potential acquisition/merger target

Their MBE certification adds diversity stacking capabilities.

---

#### Orlandini Flooring Inc.
**Threat Level: LOW — Smaller operation**

| Attribute | Details |
|-----------|---------|
| Location | W226N781 Eastmound Dr, Suite B, Waukesha, WI 53186 |
| Phone | 262-522-8060 |
| Founded | 1949 (75+ years) |
| Union Status | **UNION (INSTALL partner)** |

Family business, standard 1-year labor warranty, over 60 years experience. Union status limits competitiveness in merit-shop multifamily.

---

### Tier 3: Chicago-Based Contractors Serving Wisconsin

#### QuestMark Flooring
**Threat Level: LOW — Industrial/concrete focus**

| Attribute | Details |
|-----------|---------|
| Wisconsin Office | Via Chicago office (West Chicago, IL) |
| Phone | 630-639-5252 / 1-800-743-8890 |
| Specialty | Polished concrete, urethane, coatings |

**Market Focus:** Industrial, warehouse, manufacturing—NOT multifamily apartments. Specializes in concrete flooring solutions rather than soft flooring.

---

#### J&A Carpet Service (Homer Glen, IL)
Listed on Procore as serving Wisconsin. Limited information available. Appears to be carpet-focused.

---

#### Trevino Flooring LLC (Wheeling, IL)
Serves Wisconsin market per Procore. Focus on residential and commercial flooring including carpet, vinyl, hardwood, tile, stone, rubber, and epoxy.
...
**Gap 1: No Merit-Shop Painting + Flooring Package Provider**
- Thomas A. Mason offers the combo but is union-only
- IOC Construction offers it but is Chicago-based
...
**Gap 4: Chicago Contractors Have Logistics Disadvantage**
- IOC Construction (Batavia) is 90 miles from Milwaukee
- Travel time, mobilization costs, local relationships favor Milwaukee-based competitors

---

## Recommended Competitive Strategy

### Position 1: "Single-Source Division 9 Finishes"
...
If LaBrant pursues a hybrid model (self-perform LVP, sub-out carpet/tile), these are potential partners:
...
- Lippert (union, institutional focus)
- United Flooring (union)
- Orlandini (union)
- Thomas A. Mason (union, competitor)

---

## Contacts for Immediate Outreach

### Material Suppliers
**Sherwin-Williams FloorCovering Center**
- Location: N16W23390 Stone Ridge Dr, Waukesha, WI
- Phone: 262-549-9007
- Model: Wholesale supply with installation coordination (different from paint division)

**Nonn's Commercial Division**
- New Berlin: 262-446-6810
- Menomonee Falls: 262-255-1400
- Starnet member, provides installation crews and project managers

**Tarkett Wisconsin Rep**
- Phone: 414-299-0156 (Wauwatosa area)

### Potential Subcontractor Partners
**BYCO Tile and Floor**
- Phone: 262-894-6995
- DBE/SBE/MBE certified
...
5. **Insurance/bonding verification** — Confirm workers' comp classification codes and GL coverage requirements differ from painting
...
2. Establish subcontractor agreements for carpet/tile
3. Add flooring capabilities to GC capability statements

---

*This analysis is based on web research conducted December 30, 2024. Contact information and business details should be verified before outreach.*
