...
|----------|----------|--------------|
| **Wisconsin VendorNet** | State agencies + municipalities | eSupplier.wi.gov (free) |
| **DemandStar** | WAPP members (6+ counties) | demandstar.com/app/wapp/registration (free) |
| **QuestCDN** | Brookfield, New Berlin, Oak Creek, Kenosha | questcdn.com |
| **Bonfire** | Milwaukee City & County, Waukesha, Walworth | Portal-specific |

**NIGP Codes to Select:**
- 910-54: Painting, Maintenance and Repair Services
- 914-61: Painting, Building Construction Services
