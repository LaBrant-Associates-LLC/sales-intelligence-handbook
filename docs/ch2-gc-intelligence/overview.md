...
| Section | Jump To |
|---------|---------|
| Pipeline Overview | [Opportunity Snapshot](#opportunity-snapshot) |
| GC Rankings | [Market Snapshot](#market-snapshot) |
| **ALL 48 PROJECTS** | [Strategic Partners](strategic-partners.md) |
| Contact Directory | [Key Contacts](contacts.md) |
| Exclusions | [Avoid List](avoid-list.md) |
| Action Items | [Next Actions (90 Days)](contacts.md#next-actions-90-days) |
...
- 80% of Wisconsin's construction workforce operates merit-shop (ABC Wisconsin)
- Top 6 GC relationships generated $9.6M revenue (59% of total) at 40%+ average margins
- Union dominance persists on public K-12, government buildings, major hospitals, and data centers
- $9.0M in active proposals submitted across priority GCs
